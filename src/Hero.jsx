...
function Hero() {
  return (
    <div className="w-[92vw] m-auto pt-6.5 ">
      <div className="left mb-10">
        ...
        <h1 className="mt-4 text-4xl leading-normal">
      ...
      <div className="right mt-16 relative">
        <Stripes className="absolute top-[-6%] left-[-20%]" />
        <img src={image} alt="image" className="w-full h-auto rounded-md" />
        <div className="absolute bg-[var(--primary-dark)] rounded-md p-4 bottom-0 left-[-5%]">
          <div className="flex items-center ">
